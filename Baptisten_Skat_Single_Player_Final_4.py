...
def main():
    ...
    for i in range (10):
        ...
        print("Expected number of tricks: "+ "You: "+str(num_expect_user_trick)+" Player 2: "+str(num_expect_player_2_trick)+" Player 3: "+str(num_expect_player_3_trick))
        ...
        print("Total bid values: "+ str(total_number_expected_tricks))
        print("")
        ...
        third_player_number=get_second_player_number(second_player_number)
        #
...
def intro():
    ...
    print("While cards with the trump color are the highest, cards with the trick colors are higher than cards with other non-trump colors")
...
def get_second_player_number(second_player_number):
    if second_player_number !=3:
        third_player_number=second_player_number+1
    else: 
        third_player_number=1
